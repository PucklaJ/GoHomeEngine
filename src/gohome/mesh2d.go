...
func (oglm *OpenGLMesh2D) AddVertices(vertices []Mesh2DVertex, indices []uint32) {
...
func (oglm *OpenGLMesh2D) Load() {
	...
	var verticesSize uint32 = oglm.numVertices * MESH2DVERTEX_SIZE
	...
	gl.BindBuffer(gl.ARRAY_BUFFER, oglm.vbo)
	gl.VertexAttribPointer(0, 2, gl.FLOAT, false, int32(MESH2DVERTEX_SIZE), gl.PtrOffset(0))
	gl.VertexAttribPointer(1, 2, gl.FLOAT, false, int32(MESH2DVERTEX_SIZE), gl.PtrOffset(2*4))
