...
func (this *OpenGLES3CubeMap) GetName() string {
	return this.name
}

func CreateOpenGLES3CubeMap(name string) *OpenGLES3CubeMap {
	cubeMap := &OpenGLES3CubeMap{
		name: name,
	}
	return cubeMap
}

func (this *OpenGLES3CubeMap) Load(data []byte, width, height int, shadowMap bool) error {
...
func (this *OpenGLES3CubeMap) LoadFromImage(img image.Image) error {
	return nil
}

func (this *OpenGLES3CubeMap) Bind(unit uint32) {
	gl.ActiveTexture(gl.TEXTURE0 + unit)
	gl.BindTexture(gl.TEXTURE_CUBE_MAP, this.oglName)
}
func (this *OpenGLES3CubeMap) Unbind(unit uint32) {
	gl.ActiveTexture(gl.TEXTURE0 + unit)
	gl.BindTexture(gl.TEXTURE_CUBE_MAP, 0)

}
func (this *OpenGLES3CubeMap) GetWidth() int {
	return int(this.width)
}
func (this *OpenGLES3CubeMap) GetHeight() int {
	return int(this.height)
}
func (this *OpenGLES3CubeMap) Terminate() {
	var tex [1]uint32
	tex[0] = this.oglName
...
func (this *OpenGLES3CubeMap) SetBorderColor(col color.Color) {
	gohome.ErrorMgr.Warning("CubeMap", this.name, "SetBorderColor does not work in OpenGLES 3.0")
}
func (this *OpenGLES3CubeMap) SetBorderDepth(depth float32) {
	gohome.ErrorMgr.Warning("CubeMap", this.name, "SetBorderDepth does not work in OpenGLES 3.0")
}

func (this *OpenGLES3CubeMap) GetKeyColor() color.Color {
	return nil
}

func (this *OpenGLES3CubeMap) GetModColor() color.Color {
	return nil
}

func (this *OpenGLES3CubeMap) SetKeyColor(col color.Color) {

}

func (this *OpenGLES3CubeMap) SetModColor(col color.Color) {

}

func (this *OpenGLES3CubeMap) GetData() (data []byte, width int, height int) {
	width = this.GetWidth()
