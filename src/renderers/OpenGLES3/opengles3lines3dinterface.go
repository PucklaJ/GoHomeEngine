...
func (this *OpenGLES3Lines3DInterface) AddLines(lines []gohome.Line3D) {
	if this.loaded {
...
func (this *OpenGLES3Lines3DInterface) GetLines() []gohome.Line3D {
	return this.lines
}

func (this *OpenGLES3Lines3DInterface) attributePointer() {
...
func (this *OpenGLES3Lines3DInterface) Load() {
	if this.loaded {
		return
	}
...
func (this *OpenGLES3Lines3DInterface) Render() {
...
func (this *OpenGLES3Lines3DInterface) Terminate() {
	var buf [1]uint32
	buf[0] = this.vbo
