...
func (this *OpenGLES31Shape3DInterface) AddLines(lines []gohome.Line3D) {
	if this.loaded {
...
func (this *OpenGLES31Shape3DInterface) GetLines() []gohome.Line3D {
	return this.lines
}

func (this *OpenGLES31Shape3DInterface) attributePointer() {
...
func (this *OpenGLES31Shape3DInterface) Render() {
	...
	handleOpenGLES31Error("Shape3DInterface", this.Name, "RenderError: ")
	gl.BindVertexArray(0)
