...
func (oglm *OpenGLES31Mesh3D) CalculateTangentsRoutine(startIndex, maxIndex uint32, wg *sync.WaitGroup) {
	if wg != nil {
		defer wg.Done()
	}
...
func (oglm *OpenGLES31Mesh3D) checkAABB() {
...
func (oglm *OpenGLES31Mesh3D) deleteElements() {
...
func (oglm *OpenGLES31Mesh3D) attributePointer() {
...
func (oglm *OpenGLES31Mesh3D) GetNumVertices() uint32 {
	return oglm.numVertices
}
func (oglm *OpenGLES31Mesh3D) GetNumIndices() uint32 {
...
func (oglm *OpenGLES31Mesh3D) AABB() gohome.AxisAlignedBoundingBox {
	return oglm.aabb
}
