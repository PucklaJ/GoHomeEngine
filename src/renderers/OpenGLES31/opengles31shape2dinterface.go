...
func (this *OpenGLES31Shape2DInterface) checkVertices() bool {
	if this.loaded {
...
func (this *OpenGLES31Shape2DInterface) attributePointer() {
...
func (this *OpenGLES31Shape2DInterface) Render() {
	...
	handleOpenGLES31Error("Shape2DInterface", this.Name, "RenderError: ")
